...
#https://books.google.com/books?id=TVEbrufvvi8C&pg=PA137&lpg=PA137&dq=farmer+discount+rate&source=bl&ots=uuc30MAOY3&sig=aHDoD4PSJuOj--Nk0DwD1Hi8JY4&hl=en&sa=X&ved=0ahUKEwjyjIzbgYnZAhVE2GMKHXzeA6oQ6AEIYDAJ#v=onepage&q=farmer%20discount%20rate&f=false
...
hogAFOs$cost_scrubbers<-1.09*70*4*hogAFOs$Swine.Animal.Units+1.09*pv.annuity(hogAFOs$discount_rate,5,-20*4*hogAFOs$Swine.Animal.Units,type=1)
hogAFOs$cost_biofilter<-1.27*8.75*4*hogAFOs$Swine.Animal.Units+1.27*pv.annuity(hogAFOs$discount_rate,5,-0.525*4*hogAFOs$Swine.Animal.Units,type=1)
hogAFOs$cost_segregation<-1.27*10.4*4*hogAFOs$Swine.Animal.Units+1.27*pv.annuity(hogAFOs$discount_rate,5,-1.5*4*hogAFOs$Swine.Animal.Units,type=0)+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastsegregation,type=1)-pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$manure_valuesegregation,type=0)
...
hogAFOs$cost_impcover<-1.27*1/9*10*hogAFOs$manureSA8+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastimpcover,type=1)-pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$manure_valueimpcover,type=0) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_impcover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]<-1.27*1/9*10*hogAFOs$manureSA12[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],5,-hogAFOs$cost_broadcastimpcover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],type=1)-pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],5,-hogAFOs$manure_valueimpcover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],type=0) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_impcover[hogAFOs$Swine.Animal.Units>1000]<-1.27*1/9*10*hogAFOs$manureSA16[hogAFOs$Swine.Animal.Units>1000]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>1000],5,-hogAFOs$cost_broadcastimpcover[hogAFOs$Swine.Animal.Units>1000],type=1)-pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>1000],5,-hogAFOs$manure_valueimpcover[hogAFOs$Swine.Animal.Units>1000],type=0) #Or 12,16,20,24 depending on AFO size
...
hogAFOs$cost_percover<-1.36*1.75*hogAFOs$manureSA8+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastpercover,type=1)-pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$manure_valuepercover,type=0) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_percover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]<-1.36*1.75*hogAFOs$manureSA12[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],5,-hogAFOs$cost_broadcastpercover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],type=1)-pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],5,-hogAFOs$manure_valuepercover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],type=0) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_percover[hogAFOs$Swine.Animal.Units>1000]<-1.36*1.75*hogAFOs$manureSA16[hogAFOs$Swine.Animal.Units>1000]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>1000],5,-hogAFOs$cost_broadcastpercover[hogAFOs$Swine.Animal.Units>1000],type=1)-pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>1000],5,-hogAFOs$manure_valuepercover[hogAFOs$Swine.Animal.Units>1000],type=0) #Or 12,16,20,24 depending on AFO size
...
hogAFOs$cost_diet<-1.58*34.27*4*hogAFOs$Swine.Animal.Units-1.58*pv.annuity(hogAFOs$discount_rate,5,-1.79*10*hogAFOs$Swine.Animal.Units,type=0)+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastdiet,type=1)-pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$manure_valuediet,type=0) #feed cost is reduced, labor and capital costs increase
hogAFOs$cost_trees<-1.09*pv.annuity(hogAFOs$discount_rate,20,-0.05*4*hogAFOs$Swine.Animal.Units,type=1)
...
hogAFOs$cost_segregation_wo_manure<-1.27*10.4*4*hogAFOs$Swine.Animal.Units+1.27*pv.annuity(hogAFOs$discount_rate,5,-0.525*4*hogAFOs$Swine.Animal.Units,type=0)+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastsegregation,type=1)
...
hogAFOs$cost_impcover_wo_manure<-1.27*1/9*10*hogAFOs$manureSA8+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastimpcover,type=1) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_impcover_wo_manure[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]<-1.27*1/9*10*hogAFOs$manureSA12[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],5,-hogAFOs$cost_broadcastimpcover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],type=1) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_impcover_wo_manure[hogAFOs$Swine.Animal.Units>1000]<-1.27*1/9*10*hogAFOs$manureSA16[hogAFOs$Swine.Animal.Units>1000]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>1000],5,-hogAFOs$cost_broadcastimpcover[hogAFOs$Swine.Animal.Units>1000],type=1) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_impcover_wo_manure[hogAFOs$storagebaseline==0]<-NA
hogAFOs$cost_percover_wo_manure<-1.36*1.75*hogAFOs$manureSA8+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastpercover,type=1) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_percover_wo_manure[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]<-1.36*1.75*hogAFOs$manureSA12[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],5,-hogAFOs$cost_broadcastpercover[hogAFOs$Swine.Animal.Units>499.5&hogAFOs$Swine.Animal.Units<1001],type=1) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_percover_wo_manure[hogAFOs$Swine.Animal.Units>1000]<-1.36*1.75*hogAFOs$manureSA16[hogAFOs$Swine.Animal.Units>1000]+pv.annuity(hogAFOs$discount_rate[hogAFOs$Swine.Animal.Units>1000],5,-hogAFOs$cost_broadcastpercover[hogAFOs$Swine.Animal.Units>1000],type=1) #Or 12,16,20,24 depending on AFO size
hogAFOs$cost_percover_wo_manure[hogAFOs$storagebaseline==0]<-NA
hogAFOs$cost_diet_wo_manure<-1.58*34.27*4*hogAFOs$Swine.Animal.Units-1.58*pv.annuity(hogAFOs$discount_rate,5,-1.79*10*hogAFOs$Swine.Animal.Units,type=0)+pv.annuity(hogAFOs$discount_rate,5,-hogAFOs$cost_broadcastdiet,type=1) #feed cost is reduced, labor and capital costs increase
...
write.csv(hogAFOs,"completehogsimulationdataHIGH_May_4_2018.csv")
#write.csv(hogAFOs,"optimizationtableforexcelHIGH.csv")
...
write.csv(Comparison,file="perAUcomparisonMitigations5yrhorHIGH_May_4_2018.csv")
